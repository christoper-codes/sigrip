...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-light text-dark dark:bg-dark dark:text-light text-base md:text-lg">
        <flux:sidebar sticky stashable class="!w-[280px] border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <a href="{{ route('dashboard') }}" class="mt-4 me-5 flex items-center space-x-2 rtl:space-x-reverse" wire:navigate>
                <x-app-logo />
            </a>
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Platform')" class="grid">
                    ...
                    <flux:navlist.item class="!py-5" icon="building-office-2" :href="route('departments.index')" :current="request()->routeIs('departments.index')" wire:navigate>{{ __('Departamentos') }}</flux:navlist.item>
                </flux:navlist.group>
            </flux:navlist>
