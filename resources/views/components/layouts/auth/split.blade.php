        ...
        <div class="relative grid h-dvh flex-col items-center justify-center px-8 sm:px-0 lg:max-w-none lg:grid-cols-2 lg:px-0">
            <div class="bg-muted relative hidden h-full flex-col p-20 text-white lg:flex">
                <div class="absolute inset-0 rounded-3xl m-5 overflow-hidden">
                    ...
                    ></video>
                    <div class="absolute inset-0" style="background-image: linear-gradient(rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.3));"></div>
                </div>
                <div class="relative z-20 flex items-center">
                    <div class="flex items-center gap-2">
                            ...
                            <a href="{{ route('home') }}" wire:navigate class="font-light text-sm tracking-[0.2em] uppercase select-none text-white hover:opacity-70 transition-opacity duration-200">
                                Sigrip
                            </a>
                        </div>
                </div>
                ...
                <div class="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
                    <div class="z-20 flex flex-col items-center gap-2 font-medium lg:hidden">
                       <div class="flex items-center gap-2">
                            ...
                            <a href="{{ route('home') }}" wire:navigate class="font-light text-sm tracking-[0.2em] uppercase select-none hover:opacity-70 transition-opacity duration-200" :class="$flux.dark ? 'text-white' : 'text-black'">
                                Sigrip
                            </a>
                        </div>
                    </div>
