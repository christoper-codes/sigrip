                ...
                <main class="flex items-start gap-5 mt-16">
                    ...
                    <section class="w-full lg:w-[80%]">
                        ...
                        <flux:text class="mb-4 leading-relaxed">
                            Bienvenido a SIGRIP. Al acceder y utilizar nuestra plataforma, aceptas cumplir con los siguientes términos y condiciones. Por favor, léelos cuidadosamente antes de utilizar nuestros servicios.
                        </flux:text>

                        <flux:heading size="lg" class="mb-2">1. Uso de la plataforma</flux:heading>
                        <ul class="list-disc pl-6 mb-4 flex flex-col gap-2">
                            <flux:text>La plataforma SIGRIP está destinada exclusivamente para la gestión del bienestar laboral, análisis inteligente y cumplimiento normativo en empresas.</flux:text>
                            ...
                            <flux:text>Está prohibido el uso de SIGRIP para actividades ilícitas, fraudulentas o que atenten contra la privacidad y derechos de terceros.</flux:text>
                        </ul>
                        ...
                        <ul class="list-disc pl-6 mb-4 flex flex-col gap-2">
                            ...
                            <flux:text>SIGRIP se reserva el derecho de suspender o eliminar cuentas que incumplan estos términos.</flux:text>
                        </ul>

                        <flux:heading size="lg" class="mb-2">3. Propiedad intelectual</flux:heading>
                        <ul class="list-disc pl-6 mb-4 flex flex-col gap-2">
                            <flux:text>Todos los contenidos, marcas, logotipos, software y materiales de la plataforma son propiedad exclusiva de SIGRIP o de sus licenciantes.</flux:text>
                        ...
                        <ul class="list-disc pl-6 mb-4 flex flex-col gap-2">
                            <flux:text>SIGRIP no se hace responsable por daños directos o indirectos derivados del uso o imposibilidad de uso de la plataforma.</flux:text>
                        ...
                        <ul class="list-disc pl-6 mb-4 flex flex-col gap-2">
                            <flux:text>SIGRIP puede actualizar estos términos en cualquier momento. Se notificará a los usuarios sobre cambios relevantes.</flux:text>
                        ...
                        <ul class="list-disc pl-6 mb-4 flex flex-col gap-2">
                            <flux:text>Para consultas sobre estos términos, contáctanos en <a href="mailto:soporte@sigrip.com" class="text-primary underline">soporte@sigrip.com</a>.</flux:text>
                        </ul>

                        <flux:heading size="lg" class="mb-2">7. Uso informativo y limitación de responsabilidad</flux:heading>
                        <ul class="list-disc pl-6 mb-4 flex flex-col gap-2">
                            <flux:text>SIGRIP es una herramienta tecnológica de apoyo para el cumplimiento de la NOM-035 y la gestión del bienestar laboral. No constituye asesoría psicológica, médica ni legal, ni sustituye la intervención de profesionales en recursos humanos o salud mental.</flux:text>
                            ...
                            <flux:text>El usuario y la empresa son responsables de validar y complementar la información proporcionada por SIGRIP antes de tomar decisiones que afecten a empleados o procesos internos.</flux:text>
                        </ul>
                    </section>
                </main>
            </div>
