<header
    ...
    <div class="mx-auto transition-all duration-500 ease-in-out" :class="scrolled ? 'max-w-4xl px-6' : 'max-w-full px-0'">
        <div
            ...
            :class="scrolled ? 'backdrop-blur-lg bg-neutral-500/5 rounded-full !border-[1px] !border-neutral-800 [transition:background-color_500ms_ease-in-out,backdrop-filter_500ms_ease-in-out,border-radius_500ms_ease-in-out,border_300ms_ease-in-out_500ms]' : 'border-0 border-transparent'"
        >
            <x-main-container>
