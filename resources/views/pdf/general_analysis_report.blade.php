...
<body>
    <div class="header">
        ...
        <div class="subtitle">Departamento emisor: <strong>{{ $issuing_department }}</strong></div>
        <div class="subtitle">Departamento respondiente: <strong>{{ $executing_department }}</strong></div>
    </div>
